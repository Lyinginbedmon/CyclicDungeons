...
public class Reference
{
	...
	{
		public static final String MOD_NAME	= "Cyclic Dungeons";
		public static final String MOD_ID	= "cydun";
		...
		public static MutableText translate(String prefix, String suffix) { return Text.translatable(prefix + "." + MOD_ID + "." + suffix); }
		public static MutableText translate(String prefix, String suffix, Object... args) { return Text.translatable(prefix + "." + MOD_ID + "." + suffix, args); }
	}

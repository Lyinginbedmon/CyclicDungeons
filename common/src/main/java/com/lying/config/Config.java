...
public abstract class Config
{
	...
	public void read()
	{
		...
		{
			CyclicDungeons.LOGGER.error("Generated new config file "+fileName);
			save();
			return;
		}
		catch(IOException e)
		{
			CyclicDungeons.LOGGER.error("Couldn't read config file "+fileName);
			e.printStackTrace();
		}
	...
	public void save()
	{
		try
		{
			...
			writer.close();
			if(!fileExists)
				CyclicDungeons.LOGGER.info("Generated new config file "+fileName);
		}
		catch(IOException e)
		{
			CyclicDungeons.LOGGER.error("Couldn't read config file "+fileName);
